...
DB_NAME = os.environ.get("DATABASE_NAME", "drmafilez")
#--------------------------------------------
...
#--------------------------------------------
SHORTLINK_URL = os.environ.get("SHORTLINK_URL", "urlpx.in")
SHORTLINK_API = os.environ.get("SHORTLINK_API", "bba4d829688ece581f832b499bcfcb3d8be24dd7")
